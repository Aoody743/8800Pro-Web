    ...
    <section className="panel about-panel">
      ...
      <div className="about-copy">
        ...
        <div className="changelog">
          <p><strong>蓝牙 payload 写入</strong> 404.00857 这类乱码频率对应 `57 addr 40` 写帧头，BLE 写频现在只发送 64 字节数据区，避免把 USB 写频帧头写进空信道。</p>
