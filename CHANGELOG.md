...
- Switched Web Bluetooth read/write to the official APK-style `0x80` native block protocol while preserving a guarded fast-write path for small channel-only edits.
